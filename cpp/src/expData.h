...
public:
    static const int dim1 = 21, dim2 = 17, dim3 = 14, dim4 = 10;
...
public:
    void showData(const double arr[], const int size);
    void showBand(const double energy[], const double spin[], const int size);
};
